...
import { contentApiTwo } from '../Home/Home';
...
const Order = () => {
    ...
    const close = () => {
        ...
        document.getElementById('alert').classList.add('alerthide');
    }
    ...
    return (
        <>
            <div className="product-right">
                ...
                <button className='button-02'>Review Order
                ...
                <div id='alert' className={cart.length > 2 ? `alertshow` : `alerthide`}>

                    <div className="crcle-div"><i className="fa-solid fa-check"></i></div>
                    <span className="msg">Congratulations</span>
